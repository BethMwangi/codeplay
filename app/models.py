...
class Posts(db.Model):
    ...
    user_username = db.Column(db.String, ForeignKey('user.username'))
...
class Comment(db.Model):
    ...
    posts_id = db.Column(db.String, ForeignKey('posts.post_id'))
...
# setting the primary key in message id 
    ...
    counsellor = relationship('Counsellor')
    counsellor_id = db.Column(db.String, ForeignKey('counsellor.counsellor_id'))
    comment =relationship('Comment', ForeignKey('comment.id'))
